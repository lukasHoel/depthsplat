...
dataset.view_sampler.max_distance_between_context_views=15 \
dataset.view_sampler.context_gap_warm_up_steps=10000 \
dataset.view_sampler.initial_min_distance_between_context_views=3 \
dataset.view_sampler.initial_max_distance_between_context_views=15 \
